        ...
        <div class="w-1/3">
            <div class="flex">
                ...
                <div class="ml-2 relative">
                    ...
                    <input type="text" name="search" class="rounded-full w-56 pl-8 bg-gray-200 h-8 focus:outline-none focus:shadow-outline" placeholder="Search Facebook">
                </div>
            </div>
        </div>
        <div class="w-1/3 flex justify-center items-center h-full">
            <router-link to="/" class="px-6 flex items-center border-b-2 border-blue-500 h-full">
            ...
            <router-link to="/" class="px-6 flex items-center border-b-2 border-white h-full">
                <img src="https://image.freepik.com/free-vector/_24877-18550.jpg" alt="user profile image" class="w-8 h-8 object-cover rounded-full">
            </router-link>
            <router-link to="/" class="px-6 flex items-center border-b-2 border-white h-full">
